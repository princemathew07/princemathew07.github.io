...
\section{{\footnotesize \faBook}\textbf{ Publications}}
 \resumeSubHeadingListStart
     % \vspace{-2.0mm}
  \resumePublication
      {Synthesizing POMDP Policies: Sampling Meets Model-checking via Learning \Link{https://link.springer.com/chapter/10.1007/978-3-032-32526-6_18}{[Link]}}{\textit{CAV 2026}}
      {Co-authors: Dr.~Debraj Chakraborty, Dr.~Anirban Majumdar, Dr.~Sayan Mukherjee, Prof.~Jean-François Raskin.}{Jul 26, 2026}
  %    \vspace{-2.0mm}
  \resumePublication
      {Edit Distance of Finite-Valued Transducers \Link{https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.ICALP.2026.186}{[Link]}}{\textit{ICALP 2026}}
...
%    \resumeItemListEnd
 ...
 \section{{\footnotesize \faCoins}\textbf{ Funded Projects}}
  \resumeSubHeadingListStart
  \resumeSubheading
      {FNRS Chargé de Recherches (CR) Fellowship}{}
      {Learning and Equivalence of Automata with Resources (LEARn)}{October 2026 to September 2029}
      %\vspace{-2.0mm}
      \resumeSubHeadingListEnd
      

 \vspace{.3cm}
 \section{{\footnotesize \faMicrophone}\textbf{ Invited and Conference Talks}}
  \resumeSubHeadingListStart
  \talkPoint{Scalable Learning of One-Counter Automata via State-Merging Algorithms,\ \ \ \ \ \ \ \ \ Highlights 2026  \Link{https://www.youtube.com/watch?v=k7y9iNt_Sus}{[Talk]}}{September 10, 2026} 
  \talkPoint{Learning for the Synthesis of POMDP Policies, SNR 2026}{September 5, 2026}
    \talkPoint{Synthesizing POMDP Policies: Sampling Meets Model-checking via Learning, CAV 2026}{July 27, 2026}
  \talkPoint{Synthesizing POMDP Policies via Learning, AQUARIUM 2026}{March 24, 2026}
...
\vspace{-2.0mm}
 ...
 \section{{\footnotesize \faHandsHelping}\textbf{ Community Services}}
  \resumeSubHeadingListStart
    \resumePointt{Sub-reviewer for the Indian Conference on Logic and its Applications (ICLA), 2027}{}
  \resumePointt{Sub-reviewer for the IARCS Annual Conference on Foundations of Software 
Technology and Theoretical Computer Science (FSTTCS), 2026}{}
\resumePoint{Sub-reviewer for the International Symposium on Formal Methods (FM), 2026}{}
\resumePointt{Sub-reviewer for the IARCS Annual Conference on Foundations of Software 
Technology and Theoretical Computer Science (FSTTCS), 2025}{}
\resumePointt{Sub-reviewer for the IARCS Annual Conference on Foundations of Software 
...
%        \resumeSubHeadingListEnd
 ...
 \section{{\footnotesize \faMicrophone}\textbf{ Teaching Experience}}
  \resumeSubHeadingListStart
\resumePoint{Guest Lecturer, \textit{Software Testing and Beyond Summer School, UAntwerpen}}{Summer 2026}
  {\small\itshape Invited to deliver a two-day session on model learning.\par}
    ...
    \vspace{-2mm}
     \resumeProject
      ...
      \resumeItemListStart
        ...
        \item {This tool is associated with our paper ``CAP: A Cellular Automata Based Fuzzy Classifier''.}
    ...
    \vspace{-2mm}
     \resumeProject
      ...
      \resumeItemListStart
        ...
        \item {This tool is associated with our paper ``Optical music recognition using image processing and machine learning''.}
